...
<div id="graph-container" style="width:100%;height:80vh;min-height:600px;background:var(--warm);border-radius:var(--rad);overflow:hidden;position:relative">
  <input id="graph-search" placeholder="🔍 搜索实体..." oninput="highlightEntity(this.value)" style="position:absolute;top:12px;left:12px;z-index:5;padding:8px 16px;border:1px solid var(--line);border-radius:20px;font-size:.85rem;background:var(--bg);color:var(--ink);outline:none;width:200px">
...
<div class="section-divider"></div>
<div class="card" style="margin:16px 32px"><p style="font-size:.9rem;color:var(--mu)">💡 悬停查看关联数 | 双击跳转实体 | 拖拽节点 | 滚轮缩放 | 左上搜索框筛选高亮</p></div>
...
<script src="graph.js?v={cache_buster}"></script>
<div class="section-divider"></div>
